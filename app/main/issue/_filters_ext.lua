...
-- Filtering interest
if interest ~= "any" and interest ~= nil and ( interest == "issue" or interest == "supported" or interest == "potentially_supported" or interest == 'voted'  or interest == 'not_voted' ) then
