                                ...
                                ui.container {
                                    ...
                                    content = function()
                                        ui.container {
                                            attr = { class = "span12" },
                                            content = function()
                                                ui.heading { level = 3, attr = { class = "label label-warning" }, content = _ "Brief description" }
                                            end
                                        }
                                    end
                                }
                                ...
                                ui.container {
                                    ...
                                    content = function()
                                        ui.container {
                                            attr = { class = "span12" },
                                            content = function()
                                                ui.heading { level = 3, attr = { class = "label label-warning" }, content = _ "Detailed problem description" }
                                            end
                                        }
                                    end
                                }
                                                                ...
                                                                ui.container {
                                                                    ...
                                                                    content = function()
                                                                        ui.container {
                                                                            ...
                                                                            content = function()
                                                                                ui.container {
                                                                                    attr = { class = "span10 offset1 text-center label label-warning" },
                                                                                    content = function()
                ...
                ui.container {
                    ...
                    content = function()
                        ui.container {
                            attr = { class = "span12" },
                            content = function()
                                ui.heading { level = 3, attr = { class = "label label-warning" }, content = _ "General data" }
                            end
                        }
                    end
                }
                            ...
                            ui.container {
                                ...
                                content = function()
                                    ui.container {
                                        attr = { class = "span12" },
                                        content = function()
                                            ui.heading { level = 3, attr = { class = "label label-warning" }, content = _ "Details" }
                                        end
                                    }
                                    ui.container {
                                        attr = { class = "row-fluid" },
