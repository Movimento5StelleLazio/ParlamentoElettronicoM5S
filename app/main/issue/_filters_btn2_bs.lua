...
--              datatarget="#state_flt #interest_flt #scope_flt"
    ...
    ui.container{ attr = { id = "flt_box", class = "row-fluid", style="display:"..display_flt}, content = function()
      ui.container{ attr = { class = "span12 text-center"}, content = function()


        if btns['state'] then
          ui.container{ attr = { id = "state_flt", class = "row-fluid spaceline"}, content = function()
            ui.container{ attr = { class = "span12 text-center"}, content = function()
        ...
        if btns['interest'] then
          ui.container{ attr = { id = "interest_flt", class = "row-fluid spaceline"}, content = function()
            ui.container{ attr = { class = "span12 text-center"}, content = function()
              ui.container{ attr = { class = "row-fluid"}, content = function()
                ui.container{ attr = { class = "span12 text-center"}, content = function()
        ...
        if btns['scope'] then
          ui.container{ attr = { id = "scope_flt", class = "row-fluid spaceline" }, content = function()
            ui.container{ attr = { class = "span12 text-center"}, content = function()
              ui.container{ attr = { class = "row-fluid"}, content = function()
                ui.container{ attr = { class = "span12 text-center"}, content = function()
