...
local auditors = Member:new_selector():add_field('"member_data".residence_postcode'):join('"member_data"', nil, '"member".id="member_data".id'):add_where('"member".auditor'):exec()
