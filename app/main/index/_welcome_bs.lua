...
if app.session.member_id then
	...
	ui.container {
								...
								ui.container {
									...
									content = function()
										ui.container {
												...
												content = function()
													ui.container {
														attr = { class = "col-md-10 col-md-offset-1 spaceline" },
														content = function()
																ui.heading {
																	level = 1,
																	content = function()
		...
		ui.container {
			...
			content = function()
				ui.container {
					attr = { class = "col-md-offset-2 col-md-5 text-right spaceline " },
					content = function()
						ui.heading { level = 3, content = "La prima volta? clicca qui:" }
					end
				}
				ui.container {
					attr = { class = "col-md-2 text-left spaceline" },
					content = function()
				...
				ui.container {
					...
					content = function()
						ui.container {
								attr = { class = "col-md-10  col-xs-12 col-md-offset-1 text-center" },
								content = function()
				...
				ui.container {
					...
					content = function()
						ui.container {
								attr = { class = "col-md-6 col-sm-6 text-center hidden-xs" },
								content = function()
									ui.image {
						...
						ui.container {
								attr = { class = "col-md-6 col-sm-6 col-xs-12 text-center" },
								content = function()
									ui.image {
										attr = { class = "img_assembly_small" },
										static = "parlamento_icon_small.png"
				...
				ui.container {
					...
					content = function()
						ui.container {
								attr = { class = "col-md-6 col-sm-6 spaceline" },
								content = function()
									ui.link {
	...
	ui.container {
		...
		content = function()
				ui.container {
						attr = { class = "well col-md-6 margin-box" },
						content = function()
								execute.view {  module = 'index', view = 'login', params = { module = 'index', view = 'index', id = param.get_id() } }
						end
				}
				ui.container {
					attr = { id = "registration-info", class = "col-md-6 margin-box" },
					content = function()
