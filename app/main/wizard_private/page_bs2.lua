            ...
            ui.container {
                ...
                content = function()
                    ...
                    ui.container {
                        attr = { class = "row" },
                        content = function()
                            ui.image { attr = { class = "img-responsive" }, static = "png/step_2_f2.png" }
                        end
                    }
                end
            }
                ...
                ui.container {
                    ...
                    content = function()
                        ...
                        ui.container {
                            ...
                            content = function()
                                ui.container {
                                    attr = { class = "col-md-3 col-md-offset-1 col-sm-6 col-xs-12 text-left spaceline" },
                                    content = function()
                                        ui.tag {
                                            tag = "a",
                                ...
                                -- Pulsante "Avanti"
                                ui.container {
                                    attr = { class = "col-md-3 col-md-offset-4  col-sm-6 col-xs-12 text-right spaceline" },
                                    content = function()
                                        ui.tag {
                                            tag = "a",
