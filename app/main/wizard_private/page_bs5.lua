                                ...
                                ui.container {
                                    ...
                                    content = function()
                                        ui.container {
                                            ...
                                            content = function()
                                                ui.container {
                                                    attr = { class = "col-md-6 col-md-col-md-offset--3 text-center spaceline" },
                                                    content = function()
                                                        ui.heading {
                                                            level = 3,
                                                                    ...
                                                                    content = function()
                                                                        ui.container {
                                                                            ...
                                                                            content = function()
                                                                                ui.tag {
                                                                                    tag = "textarea",
                                                                                    attr = { id = "problem_description", name = "problem_description", style = "resize:none;height:260px;", class = "col-md-12" },
