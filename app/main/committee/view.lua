...
local committee_id = param.get("committee_id", atom.integer) or 0
		 ...
		 ui.container{attr={class = "span12 well"}, content = function()
		   ui.container{attr={class="row-fluid"},content = function()
		    ui.image{attr={class="span3 offset1"}, static="png/committee_big.png" }
                     ui.container{attr={class="span6 offset1 text-center spaceline3"},content = function()
		      ui.container{attr={class="row-fluid label label-warning"},content = function()
	...
	if committee_id == 0 then 
		ui.container{attr={class = "row-fluid spaceline"}, content = function()
		  ...
		  ui.container{attr={class = "span6 text-justify"}, content = function()
