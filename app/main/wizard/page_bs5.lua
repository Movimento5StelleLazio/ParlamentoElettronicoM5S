...
trace.debug( "initiative_brief_description: "..initiative_brief_description )
trace.debug( "draft: "..draft )
trace.debug( "technical_area_1: "..tostring(technical_area_1) )
trace.debug( "technical_area_2: "..tostring(technical_area_2) )
trace.debug( "technical_area_3: "..tostring(technical_area_3) )
trace.debug( "technical_area_4: "..tostring(technical_area_4) )
trace.debug( "proposer1: "..tostring(proposer1) )
trace.debug( "proposer2: "..tostring(proposer2) )
trace.debug( "proposer3: "..tostring(proposer3) ) 
		...
		ui.container{attr={class="row-fluid well"},content=function()
				...
				ui.container{attr={class="row-fluid depression_box paper"},content=function()
						...
						ui.container{attr={class="row-fluid spaceline3"},content=function()
							ui.container{attr={class="span4 offset1 pagination-justify alert alert-info issue_desc"},content=function()
