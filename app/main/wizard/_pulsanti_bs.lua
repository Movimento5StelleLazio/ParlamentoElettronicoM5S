...
ui.container{attr={class="row-fluid"},content=function()
  ...
  ui.tag{
      tag="a",
      attr={id="btnNext",class="btn btn-primary btn-large table-cell eq_btn",onmousedown="document.getElementById('wizardForm"..page.."').submit();"},
      module = "wizard",
...
ui.container{attr={class="row-fluid"},content=function()
  ui.container{attr={class="span3 text-center"},content=function()
    ui.tag{
      tag="a",
      attr={id="btnPreviuos",class="btn btn-primary btn-large table-cell eq_btn",onmousedown="document.getElementsByName('indietro')[0].value=true;document.getElementById('wizardForm"..page.."').submit();"},
