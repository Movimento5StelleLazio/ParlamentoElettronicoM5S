            ...
            --contenuto specifico della pagina wizard    
             ui.form
                    ...
                    --parametri in uscita 
                          ...
                          ui.container{attr={class="row-fluid"},content=function()
                            ui.container{attr={class="span5 offset1 text-left collapse",style="height:100%;"},content=function()
                              ui.tag{tag="p",content=  _"Keywords"}
                              ui.tag{tag="em",content=  _"Keywords note"}
                            end }
                            ui.container{attr={class="span5 collapse",style="height:15em;"},content=function()
                              ui.tag{
                                tag="input", 
