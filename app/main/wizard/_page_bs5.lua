...
ui.container{attr={class="row-fluid"},content=function()
  ui.container{attr={class="span12 text-center"},content=function()
    ...
    ui.heading{level=4,content=  _"Problem description title" }
  end }
end }
                                   ...
                                   content=function()  
                                    ...
                                    ui.container
                                    {
                                        ...
                                        ui.tag
                                           {
                                                tag="textarea",
                                                attr={id="problem_description", name="problem_description",style="resize: none;float: left; font-size: 23px; height: 228px; margin-left: 15px; width: 598px;"},
                                                content=function()
                                                end
