        ...
        ui.container {
            ...
            content = function()
                            ...
                            content = function()
                                ...
                                for i, k in ipairs(area_policies) do
                                    policies[#policies + 1] = { id = k.policy_id, name = Policy:by_id(k.policy_id).name }
                                        ...
                                        ui.container {
                                            attr = { class = "row-fluid formSelect" .. disable  },
                                            content = function()
                                                ui.container {
				                        ...
				                        ui.container {
				                            ...
				                            content = function()
				                                ui.container {
				                                    attr = { class = "span8 offset3 text-left spaceline-bottom" },
				                                    content = function()
                                ...
                                ui.container {
                                    ...
                                    content = function()
                                        ui.container {
                                            attr = { class = "span12 well-inside paper spaceline3" },
                                            content = function()
                                            --Titolo box questione
                                                ...
                                                ui.container {
                                                    ...
                                                    content = function()
                                                        ...
                                                        ui.container {
                                                            ...
                                                            content = function()
                                                                ui.tag { tag = "input", attr = { id = "issue_title", name = "issue_title", value = issue_title or "", style = "width:80%;" }, content = "" }
                                                            end
                                                        }
                                                    end
                                                }
                                                ...
                                                ui.container {
                                                    ...
                                                    content = function()
                                                        ...
                                                        ui.container {
                                                            attr = { class = "row-fluid text-center spaceline" },
                                                            content = function()
                                                                ui.tag {
                                                                    tag = "textarea",
                                                                    attr = { id = "issue_brief_description", name = "issue_brief_description", style = "width:80%;height:100%;resize:none;" },
                                                ...
                                                ui.container {
                                                    attr = { class = "row-fluid spaceline4 spaceline-bottom" },
                                                    content = function()
                                                        ui.container {
                                                            attr = { class = "row-fluid text-center" },
                                                            content = function()
                                                        ...
                                                        ui.container {
                                                            ...
                                                            content = function()
                                                                ui.tag {
                                                                    tag = "textarea",
                                                                    attr = { id = "problem_description", name = "problem_description", style = "height:100%;width:80%;resize:none;" },
                                                    ...
                                                    content = function()
                                                        ...
                                                        ui.container {
                                                            ...
                                                            content = function()
                                                                ui.tag {
                                                                    tag = "textarea",
                                                                    attr = { id = "aim_description", name = "aim_description", style = "height:100%;width:80%;resize:none;" },
                                        ...
                                        ui.container {
                                            ...
                                            -- Titolo box proposta
                                                ui.container {
                                                    ...
                                                    content = function()
                                                        ui.container {
                                                            attr = { class = "span6 offset3 text-center label label-warning spaceline3" },
                                                            content = function()
                                                ...
                                                ui.container {
                                                    ...
                                                    content = function()
                                                        ui.container {
                                                            attr = { class = "row-fluid text-center spaceline3" },
                                                            content = function()
                                                        ...
                                                        ui.container {
                                                            attr = { class = "row-fluid text-center spaceline" },
                                                            content = function()
                                                                ui.tag { tag = "input", attr = { id = "initiative_title", name = "initiative_title", value = initiative_title, style = "width:80%;" }, content = "" }
                                                            end
                                                        }
                                                    end
                                                }
                                                    ...
                                                    content = function()
                                                        ...
                                                        ui.container {
                                                            ...
                                                            content = function()
                                                                ui.tag {
                                                                    tag = "textarea",
                                                                    attr = { id = "initiative_brief_description", name = "initiative_brief_description", style = "height:100%;width:80%;resize:none;" },
                                                    ...
                                                    content = function()
                                                        ...
                                                        ui.container {
                                                            ...
                                                            content = function()
                                                                ui.tag {
                                                                    tag = "textarea",
                                                                    attr = { id = "draft", name = "draft", style = "height:100%;width:80%;resize:none;" },
                                                                    content = draft or ""
                                                                }
                                                            end
                                                        }
                                                ...
                                                ui.container {
                                                    ...
                                                    content = function()
                                                        ui.container {
                                                            attr = { class = "row-fluid text-center" },
                                                            content = function()
                                                                ui.tag { tag = "h1", content = _ "Youtube video" }
                                                            --                      ui.tag{tag="em",content=  _"Draft note"}
                                                            end
                                                        }
                                                        ui.container {
                ...
                -- Pulsanti
                                ...
                                ui.container {
                                    attr = { id = "pulsanti", class= "row-fluid spaceline"},
                                    content = function()
                                                        ui.container {
                                                            attr = { class = "span3 offset2 text-center" },
                                                            content = function()
                                                            --pulsante anteprima
                                                                ui.container {
                                                                    attr = { id = "btnAnteprima", class = "btn btn-primary large_btn fixclick", disabled = "true", style = "opacity:0.5;float:left;" },
                                                                    module = "wizard",
                                                                    view = "anteprima",
                                                                    content = function()
                                                                        ui.heading {
                                                        ...
                                                        ui.container {
                                                            ...
                                                            content = function()
                                                                ui.container {
                                                                    attr = { id = "btnSalvaPreview", class = "btn btn-primary large_btn fixclick", disabled = "true", style = "opacity:0.5;float:left;" },
                                                                    module = "wizard",
                                                                    view = "_save_preview",
                                                                    content = function()
                                                                        ui.heading {
