...
ui.container{attr={id="contenitore", class="accordion"},
	content = function()
		ui.container{attr={class="accordion-group"},
			content = function()
				ui.container{attr={class="row-fluid"},
					content=function()
						ui.container{attr={class="accordion-heading span12 text-center"},
							content = function()
								ui.tag {
									tag = "button",
				...
				ui.container{attr={id="filtri", class="accordion-body collapse"..collapse},
					content = function()
						ui.container{ attr={class= "row-fluid"},
							content = function()
								ui.container{ attr = { class = "span12 text-center"},
									content = function()
										if btns['state'] then
											ui.container{ attr = { id = "state_flt", class = "row-fluid spaceline"},
												content = function()
													ui.container{ attr = { class = "span12 text-center"},
														content = function()
															ui.container{ attr = { class = "row-fluid"},
																			...
																			for i=1, #btns.state do
																				ui.container{ attr = { class = "row-fluid"}, 
																					content = function()
																						ui.container{ attr = { class = "span12 text-center"}, 
																							content = function()
																								ui.container{ attr = { class = "btn-group" }, 
																									content=function()
										...
										if btns['interest'] then
											ui.container{ attr = { id = "interest_flt", class = "row-fluid spaceline"}, 
												content = function()
													ui.container{ attr = { class = "span12 text-center"}, 
														content = function()
															ui.container{ attr = { class = "row-fluid"}, 
										...
										if btns['scope'] then
											ui.container{ attr = { id = "scope_flt", class = "row-fluid spaceline" }, 
												content = function()
													ui.container{ attr = { class = "span12 text-center"}, 
														content = function()
															ui.container{ attr = { class = "row-fluid"}, 
