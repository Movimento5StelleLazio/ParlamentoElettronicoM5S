...
if not page  or page <= 1 then
    ...
    ui.container{attr={class="row-fluid"},content=function()
     ...
     ui.container{attr={class="row-fluid spaceline"},content=function()
      ui.container{attr={class="span12 text-center"},content=function()
        ui.image{ static = "svg/commission_box_step2.svg" }
      end }
     end }
    ...
    ui.container{attr={class="row-fluid"},content=function()
     ui.container{attr={class="span3 offset2 text-center spaceline"},content=function()
      ui.image{ static = "svg/committee.svg" }
       end }

     ui.container{attr={class="span4 text-center spaceline4"},content=function()
      ui.tag{tag="h2",content=  "COMMISSIONE RICHIESTA"} 
       end }
      end }
   ui.container{attr={class="row-fluid spaceline2"},content=function()
        ...
        ui.container{attr={class="row-fluid"},content=function()
         ui.container{attr={class="span10 offset1 text-center spaceline3"},content=function()
          ui.tag{tag="h3",content=  "HAI PRESENTATO RICHIESTA PER CONVOCARE UNA COMMISSIONE TECNICA CON LE SEGUENTI COMPETENZE:"}   
                   end }
                end }
	...
	ui.container{attr={class="row-fluid spaceline2"},content=function() 
     ...
     ui.container{attr={class="row-fluid"},content=function()
      ui.container{attr={class="span10 offset1 text-justify spaceline4"},content=function()
     ...
     ui.container{attr={class="row-fluid"},content=function()
      ui.container{attr={class="span5 offset1 text-justify spaceline4"},content=function()
       ui.tag{tag="h3",content=  "Per conoscere i dettagli dell' algoritmo, premere questo bottone:"}       
         end }
