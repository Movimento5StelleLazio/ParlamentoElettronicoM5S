...
!function ($) {
    ...
    Alert.prototype.close = function (e) {
        var $this = $(this), selector = $this.attr('datatarget'), $parent
        if (!selector) {
...
!function ($) {
    ...
    Button.prototype.toggle = function () {
        var $parent = this.$element.closest('[datatoggle="buttons-radio"]')
    ...
    $(document).on('click.button.data-api', '[datatoggle^=button]', function (e) {
        var $btn = $(e.target)
...
!function ($) {
    ...
    $(document).on('click.carousel.data-api', '[data-slide], [data-slide-to]', function (e) {
        var $this = $(this), href, $target = $($this.attr('datatarget') || (href = $this.attr('href')) && href.replace(/.*(?=#[^\s]+$)/, '')), options = $.extend({}, $target.data(), $this.data()), slideIndex
...
!function ($) {
    ...
    $(document).on('click.collapse.data-api', '[datatoggle=collapse]', function (e) {
        var $this = $(this), href, target = $this.attr('datatarget') || e.preventDefault() || (href = $this.attr('href')) && href.replace(/.*(?=#[^\s]+$)/, ''), option = $(target).data('collapse') ? 'toggle' : $this.data()
...
!function ($) {
    "use strict";
    var toggle = '[datatoggle=dropdown]', Dropdown = function (element) {
    ...
    function getParent($this) {
        var selector = $this.attr('datatarget'), $parent
        if (!selector) {
            selector = $this.attr('href')
...
!function ($) {
    ...
    $(document).on('click.modal.data-api', '[datatoggle="modal"]', function (e) {
        var $this = $(this), href = $this.attr('href'), $target = $($this.attr('datatarget') || (href && href.replace(/.*(?=#[^\s]+$)/, ''))), option = $target.data('modal') ? 'toggle' : $.extend({remote: !/#/.test(href) && href}, $target.data(), $this.data())
        e.preventDefault()
...
!function ($) {
    ...
    Tab.prototype = {constructor: Tab, show: function () {
        var $this = this.element, $ul = $this.closest('ul:not(.dropdown-menu)'), selector = $this.attr('datatarget'), previous, $target, e
        if (!selector) {
            selector = $this.attr('href')
            selector = selector && selector.replace(/.*(?=#[^\s]*$)/, '')
        }
    ...
    $(document).on('click.tab.data-api', '[datatoggle="tab"], [datatoggle="pill"]', function (e) {
        e.preventDefault()
        $(this).tab('show')
    })
}(window.jQuery);
