    ...
    for (var key in params) {
        ...
        if (value instanceof Array) {
            ...
            for (i = 0; i < value.length; i++) {
                if (result != "") result += "&";
                result += encodeURIComponent(key) + "=" + encodeURIComponent(value[i].toString());
            }
        } else {
            if (result != "") result += "&";
...
function queuedHttpRequest(url_or_form, urlParams, postParams, successHandler, failureHandler) {
    var method;
    var data = null;
...
function partialLoad(node, tempLoadingContent, failureContent, url_or_form, urlParams, postParams, successHandler, failureHandler) {
...
function partialMultiLoad(mapping, tempLoadingContents, failureContents, url_or_form, urlParams, postParams, successHandler, failureHandler) {
